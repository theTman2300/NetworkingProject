...
public class Server : MonoBehaviour
{
    ...
    {
        //Figure out a way to see if a connection is disconnected
        //connection.Status equals connected, even is not
    }
    ...
    public void GameFull(TcpNetworkConnection newClient)
    {
        OSCMessageOut message = new OSCMessageOut("/GameFull");
        newClient.Send(message.GetBytes());
    }

    public void OtherPlayerDisconnected()
    {
        OSCMessageOut message = new OSCMessageOut("/OtherPlayerDisconnected");
        Broadcast(message.GetBytes());
    }
}
